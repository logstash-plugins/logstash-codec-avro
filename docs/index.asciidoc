...
[NOTE]
================================================================================
This codec doesn't support partial deserialization of arbitrary fields providing
a schema containing a subset of the fields.
Partial deserialization might work only if you specify a schema which contains
the first `N` fields of the writer schema (and in the same order).
================================================================================
